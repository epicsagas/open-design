...
export const th: Dict = {
  ...
  'settings.desktop': 'เดสก์ท็อป',
  'settings.desktopHint': 'กำหนดค่าพฤติกรรมของแอปเดสก์ท็อป',
  'settings.autoLaunch': 'เริ่มตอนเข้าสู่ระบบ',
  'settings.autoLaunchHint': 'เริ่ม Open Design อัตโนมัติเมื่อคุณเข้าสู่ระบบ',
  'settings.network': 'เครือข่าย',
  'settings.networkHint': 'กำหนดค่าว่า daemon จะผูกกับอินเทอร์เฟซเครือข่ายอย่างไร',
  'settings.networkRequiresDaemon': 'เชื่อมต่อกับ daemon ที่กำลังทำงานเพื่อกำหนดค่าการตั้งค่าเครือข่าย',
  'settings.networkWarning': 'เปิดการเปิดเผยเครือข่ายแล้ว',
  'settings.networkWarningHint': 'Daemon สามารถเข้าถึงได้จากเครือข่ายของคุณ เปิดการยืนยันตัวตนด้วยคีย์ API และตั้งค่ารายการ IP ที่อนุญาต',
  'settings.bindHost': 'ที่อยู่การผูก',
  'settings.bindHostHint': '127.0.0.1 = localhost เท่านั้น 0.0.0.0 = อินเทอร์เฟซเครือข่ายทั้งหมด',
  'settings.port': 'พอร์ต',
  'settings.portHint': 'พอร์ต TCP ที่ daemon รับฟัง ค่าเริ่มต้น: 7456',
  'settings.allowedHosts': 'โฮสต์ที่อนุญาต',
  'settings.allowedHostsHint': 'IP หรือช่วง CIDR คั่นด้วยจุลภาคที่อนุญาตให้เชื่อมต่อ ว่าง = ทั้งหมด',
  'settings.apiKeys': 'คีย์ API',
  'settings.apiKeysHint': 'คีย์ที่จำเป็นสำหรับการเชื่อมต่อที่ไม่ใช่ภายในเมื่อเปิดการเปิดเผยเครือข่าย',
  'settings.revoke': 'เพิกถอน',
  'settings.newApiKey': 'คีย์ API ใหม่',
  'settings.newApiKeyHint': 'คัดลอกคีย์นี้เดี๋ยวนี้ จะไม่แสดงอีก',
  'settings.keyLabel': 'ป้ายกำกับ (ไม่บังคับ)',
  'settings.generateKey': 'สร้าง',
  'settings.networkKeyRequired': 'การเข้าถึงเครือข่ายต้องใช้คีย์ API',
  'settings.networkKeyRequiredHint': 'การผูกกับอินเทอร์เฟซทั้งหมดจะเปิดเผย daemon ให้เครือข่าย ระบบจะสร้างคีย์ API ขึ้นเพื่อความปลอดภัย',
  'settings.generateAndSwitch': 'สร้างคีย์และสลับ',
  'settings.networkNoKeysWarning': 'ไม่สามารถรีสตาร์ทได้หากไม่มีคีย์ API',
  'settings.networkNoKeysWarningHint': 'ต้องมีคีย์ API อย่างน้อยหนึ่งคีย์เมื่อ daemon เปิดเผยต่อเครือข่าย กรุณาสร้างคีย์ด้านบนก่อนรีสตาร์ท',
  'settings.networkRestartHint': 'การเปลี่ยนแปลงที่อยู่การผูก พอร์ต หรือโฮสต์ที่อนุญาต จำเป็นต้องรีสตาร์ท daemon',
  'settings.restartDaemon': 'รีสตาร์ท Daemon',
  'settings.restartingDaemon': 'กำลังรีสตาร์ท…',
  'settings.restartFailed': 'รีสตาร์ทล้มเหลว กรุณารีสตาร์ทด้วยตนเอง',
  'settings.networkSaveError': 'บันทึกไม่สำเร็จ ตรวจสอบข้อมูลแล้วลองอีกครั้ง',
  'settings.networkLoadError': 'โหลดการตั้งค่าเครือข่ายไม่สำเร็จ',
  ...
  'settings.mcpKeysRevoke': 'เพิกถอน',
