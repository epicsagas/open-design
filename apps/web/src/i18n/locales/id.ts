...
export const id: Dict = {
  ...
  'settings.desktopHint': 'Atur perilaku aplikasi desktop.',
  'settings.autoLaunch': 'Mulai saat masuk',
  'settings.autoLaunchHint': 'Otomatis mulai Open Design saat kamu masuk.',
  'settings.network': 'Jaringan',
  'settings.networkHint': 'Atur bagaimana daemon terikat ke antarmuka jaringan.',
  'settings.networkRequiresDaemon': 'Hubungkan ke daemon yang berjalan untuk mengatur pengaturan jaringan.',
  'settings.networkWarning': 'Paparan jaringan diaktifkan',
  'settings.networkWarningHint': 'Daemon dapat diakses dari jaringanmu. Aktifkan autentikasi kunci API dan atur daftar IP yang diizinkan.',
  'settings.bindHost': 'Alamat ikatan',
  'settings.bindHostHint': '127.0.0.1 = hanya localhost. 0.0.0.0 = semua antarmuka jaringan.',
  'settings.port': 'Port',
  'settings.portHint': 'Port TCP yang didengarkan daemon. Default: 7456.',
  'settings.allowedHosts': 'Host yang diizinkan',
  'settings.allowedHostsHint': 'IP atau rentang CIDR yang dipisahkan koma yang diizinkan terhubung. Kosong = semua.',
  'settings.apiKeys': 'Kunci API',
  'settings.apiKeysHint': 'Kunci yang diperlukan untuk koneksi non-lokal saat paparan jaringan aktif.',
  'settings.revoke': 'Cabut',
  'settings.newApiKey': 'Kunci API baru',
  'settings.newApiKeyHint': 'Salin kunci ini sekarang. Tidak akan ditampilkan lagi.',
  'settings.keyLabel': 'Label (opsional)',
  'settings.generateKey': 'Buat',
  'settings.networkKeyRequired': 'Akses jaringan memerlukan kunci API',
  'settings.networkKeyRequiredHint': 'Mengikat ke semua antarmuka mengekspos daemon ke jaringan. Kunci API akan dibuat untuk keamanan.',
  'settings.generateAndSwitch': 'Buat Kunci & Beralih',
  'settings.networkNoKeysWarning': 'Tidak dapat memulai ulang tanpa kunci API',
  'settings.networkNoKeysWarningHint': 'Setidaknya satu kunci API diperlukan saat daemon terekspos ke jaringan. Buat kunci di atas sebelum memulai ulang.',
  'settings.networkRestartHint': 'Perubahan alamat ikatan, port, atau host yang diizinkan memerlukan restart daemon.',
  'settings.restartDaemon': 'Mulai ulang daemon',
  'settings.restartingDaemon': 'Memulai ulang…',
  'settings.restartFailed': 'Gagal memulai ulang. Coba secara manual.',
  'settings.networkSaveError': 'Gagal menyimpan. Periksa input dan coba lagi.',
  'settings.networkLoadError': 'Gagal memuat pengaturan jaringan.',
  ...
  'settings.mcpInstructionGemini': 'Gabungkan JSON ini ke dalam {path}.',
