...
export const zhCN: Dict = {
  ...
  'settings.desktop': '桌面',
  'settings.desktopHint': '配置桌面应用行为。',
  'settings.autoLaunch': '登录时启动',
  'settings.autoLaunchHint': '登录时自动启动 Open Design。',
  'settings.network': '网络',
  'settings.networkHint': '配置守护进程的网络接口绑定方式。',
  'settings.networkRequiresDaemon': '连接到运行中的守护进程以更改网络设置。',
  'settings.networkWarning': '网络暴露已启用',
  'settings.networkWarningHint': '守护进程可从网络访问。请启用 API 密钥认证并设置 IP 白名单。',
  'settings.bindHost': '绑定地址',
  'settings.bindHostHint': '127.0.0.1 = 仅本地。0.0.0.0 = 所有网络接口。',
  'settings.port': '端口',
  'settings.portHint': '守护进程监听的 TCP 端口。默认值: 7456。',
  'settings.allowedHosts': '允许的主机',
  'settings.allowedHostsHint': '允许连接的 IP 或 CIDR 范围，逗号分隔。留空 = 允许所有。',
  'settings.apiKeys': 'API 密钥',
  'settings.apiKeysHint': '网络暴露时非本地连接所需的认证密钥。',
  'settings.revoke': '撤销',
  'settings.newApiKey': '新 API 密钥',
  'settings.newApiKeyHint': '请立即复制此密钥，之后不会再次显示。',
  'settings.keyLabel': '标签（可选）',
  'settings.generateKey': '生成',
  'settings.networkKeyRequired': '网络访问需要 API 密钥',
  'settings.networkKeyRequiredHint': '绑定到所有接口会将守护进程暴露给网络。将生成 API 密钥以确保安全。',
  'settings.generateAndSwitch': '生成密钥并切换',
  'settings.networkNoKeysWarning': '没有 API 密钥无法重启',
  'settings.networkNoKeysWarningHint': '守护进程暴露在网络中时，至少需要一个 API 密钥。请在重启前先生成密钥。',
  'settings.networkRestartHint': '更改绑定地址、端口或允许的主机后需要重启守护进程。',
  'settings.restartDaemon': '重启守护进程',
  'settings.restartingDaemon': '正在重启…',
  'settings.restartFailed': '重启失败，请手动重启。',
  'settings.networkSaveError': '保存失败，请检查输入后重试。',
  'settings.networkLoadError': '加载网络设置失败。',
