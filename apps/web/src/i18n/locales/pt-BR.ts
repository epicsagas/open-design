...
export const ptBR: Dict = {
  ...
  'settings.desktopHint': 'Configurar comportamento do aplicativo desktop.',
  'settings.autoLaunch': 'Iniciar ao fazer login',
  'settings.autoLaunchHint': 'Iniciar automaticamente o Open Design ao fazer login.',
  'settings.network': 'Rede',
  'settings.networkHint': 'Configurar como o daemon se vincula às interfaces de rede.',
  'settings.networkRequiresDaemon': 'Conecte-se a um daemon em execução para alterar as configurações de rede.',
  'settings.networkWarning': 'Exposição de rede ativada',
  'settings.networkWarningHint': 'O daemon está acessível pela rede. Ative a autenticação por chave API e defina uma lista de IPs permitidos.',
  'settings.bindHost': 'Endereço de vinculação',
  'settings.bindHostHint': '127.0.0.1 = apenas localhost. 0.0.0.0 = todas as interfaces de rede.',
  'settings.port': 'Porta',
  'settings.portHint': 'Porta TCP que o daemon escuta. Padrão: 7456.',
  'settings.allowedHosts': 'Hosts permitidos',
  'settings.allowedHostsHint': 'IPs ou faixas CIDR permitidos, separados por vírgula. Vazio = todos.',
  'settings.apiKeys': 'Chaves API',
  'settings.apiKeysHint': 'Chaves necessárias para conexões não locais quando a exposição de rede está ativada.',
  'settings.revoke': 'Revogar',
  'settings.newApiKey': 'Nova chave API',
  'settings.newApiKeyHint': 'Copie esta chave agora. Ela não será exibida novamente.',
  'settings.keyLabel': 'Rótulo (opcional)',
  'settings.generateKey': 'Gerar',
  'settings.networkKeyRequired': 'O acesso à rede requer uma chave de API',
  'settings.networkKeyRequiredHint': 'Vincular a todas as interfaces expõe o daemon à rede. Uma chave de API será gerada por segurança.',
  'settings.generateAndSwitch': 'Gerar chave e alternar',
  'settings.networkNoKeysWarning': 'Não é possível reiniciar sem uma chave de API',
  'settings.networkNoKeysWarningHint': 'Pelo menos uma chave de API é necessária quando o daemon está exposto à rede. Gere uma chave acima antes de reiniciar.',
  'settings.networkRestartHint': 'Alterações no endereço de vinculação, porta ou hosts permitidos exigem reinicialização do daemon.',
  'settings.restartDaemon': 'Reiniciar daemon',
  'settings.restartingDaemon': 'Reiniciando…',
  'settings.restartFailed': 'Falha ao reiniciar. Tente manualmente.',
  'settings.networkSaveError': 'Falha ao salvar. Verifique os dados e tente novamente.',
  'settings.networkLoadError': 'Falha ao carregar as configurações de rede.',
  ...
  'settings.mcpKeysRevoke': 'Revogar',
