...
export const ko: Dict = {
  ...
  'settings.desktopHint': '데스크톱 앱 동작을 설정합니다.',
  'settings.autoLaunch': '로그인 시 시작',
  'settings.autoLaunchHint': '로그인할 때 Open Design을 자동으로 시작합니다.',
  'settings.network': '네트워크',
  'settings.networkHint': '데몬의 네트워크 인터페이스 바인딩을 설정합니다.',
  'settings.networkRequiresDaemon': '실행 중인 데몬에 연결하여 네트워크 설정을 변경할 수 있습니다.',
  'settings.networkWarning': '네트워크 노출 활성화됨',
  'settings.networkWarningHint': '데몬이 네트워크에서 접근 가능합니다. API 키 인증과 IP 허용 목록을 설정하세요.',
  'settings.bindHost': '바인드 주소',
  'settings.bindHostHint': '127.0.0.1 = 로컬호스트만. 0.0.0.0 = 모든 네트워크 인터페이스.',
  'settings.port': '포트',
  'settings.portHint': '데몬이 수신할 TCP 포트. 기본값: 7456.',
  'settings.allowedHosts': '허용 호스트',
  'settings.allowedHostsHint': '접속을 허용할 IP 또는 CIDR 범위 (쉼표 구분). 비워두면 모두 허용.',
  'settings.apiKeys': 'API 키',
  'settings.apiKeysHint': '네트워크 노출 시 로컬이 아닌 연결에 필요한 인증 키.',
  'settings.revoke': '폐지',
  'settings.newApiKey': '새 API 키',
  'settings.newApiKeyHint': '지금 이 키를 복사하세요. 다시 표시되지 않습니다.',
  'settings.keyLabel': '레이블 (선택)',
  'settings.generateKey': '생성',
  'settings.networkKeyRequired': '네트워크 접근에 API 키가 필요합니다',
  'settings.networkKeyRequiredHint': '모든 인터페이스에 바인딩하면 데몬이 네트워크에 노출됩니다. 보안을 위해 API 키가 생성됩니다.',
  'settings.generateAndSwitch': '키 생성 후 전환',
  'settings.networkNoKeysWarning': 'API 키 없이 재시작할 수 없습니다',
  'settings.networkNoKeysWarningHint': '데몬이 네트워크에 노출된 경우 최소 하나의 API 키가 필요합니다. 재시작 전에 위에서 키를 생성하세요.',
  'settings.networkRestartHint': '바인드 주소, 포트 또는 허용 호스트 변경 후 데몬을 재시작해야 합니다.',
  'settings.restartDaemon': '데몬 재시작',
  'settings.restartingDaemon': '재시작 중…',
  'settings.restartFailed': '재시작에 실패했습니다. 직접 재시작해 주세요.',
