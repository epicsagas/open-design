...
export const ar: Dict = {
  ...
  'settings.desktopHint': 'تكوين سلوك تطبيق سطح المكتب.',
  'settings.autoLaunch': 'التشغيل عند تسجيل الدخول',
  'settings.autoLaunchHint': 'تشغيل Open Design تلقائيًا عند تسجيل الدخول.',
  'settings.network': 'الشبكة',
  'settings.networkHint': 'تكوين كيفية ربط البرنامج الخفي بواجهات الشبكة.',
  'settings.networkRequiresDaemon': 'اتصل ببرنامج خفي قيد التشغيل لتغيير إعدادات الشبكة.',
  'settings.networkWarning': 'العرض الشبكي مفعّل',
  'settings.networkWarningHint': 'البرنامج الخفي قابل للوصول من الشبكة. فعّل مصادقة مفتاح API واضبط قائمة IP المسموحة.',
  'settings.bindHost': 'عنوان الربط',
  'settings.bindHostHint': '127.0.0.1 = المضيف المحلي فقط. 0.0.0.0 = جميع واجهات الشبكة.',
  'settings.port': 'المنفذ',
  'settings.portHint': 'منفذ TCP الذي يستمع إليه البرنامج الخفي. الافتراضي: 7456.',
  'settings.allowedHosts': 'المضيفون المسموحون',
  'settings.allowedHostsHint': 'عناوين IP أو نطاقات CIDR مفصولة بفواصل. فارغ = الكل.',
  'settings.apiKeys': 'مفاتيح API',
  'settings.apiKeysHint': 'مفاتيح مطلوبة للاتصالات غير المحلية عند تفعيل العرض الشبكي.',
  'settings.revoke': 'إلغاء',
  'settings.newApiKey': 'مفتاح API جديد',
  'settings.newApiKeyHint': 'انسخ هذا المفتاح الآن. لن يظهر مرة أخرى.',
  'settings.keyLabel': 'تسمية (اختياري)',
  'settings.generateKey': 'توليد',
  'settings.networkKeyRequired': 'الوصول إلى الشبكة يتطلب مفتاح API',
  'settings.networkKeyRequiredHint': 'الربط بجميع الواجهات يعرض الخادم للشبكة. سيتم إنشاء مفتاح API للأمان.',
  'settings.generateAndSwitch': 'إنشاء مفتاح والتبديل',
  'settings.networkNoKeysWarning': 'لا يمكن إعادة التشغيل بدون مفتاح API',
  'settings.networkNoKeysWarningHint': 'يلزم مفتاح API واحد على الأقل عندما يكون الخادم معرضًا للشبكة. أنشئ مفتاحًا أعلاه قبل إعادة التشغيل.',
  'settings.networkRestartHint': 'تغييرات عنوان الربط أو المنفذ أو المضيفين المسموحين تتطلب إعادة تشغيل البرنامج الخفي.',
  'settings.restartDaemon': 'إعادة تشغيل الخادم',
  'settings.restartingDaemon': 'جارٍ إعادة التشغيل…',
  'settings.restartFailed': 'فشلت إعادة التشغيل. حاول يدويًا.',
  'settings.networkSaveError': 'فشل الحفظ. تحقق من الإدخال وحاول مرة أخرى.',
  'settings.networkLoadError': 'فشل تحميل إعدادات الشبكة.',
