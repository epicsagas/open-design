...
export const fr: Dict = {
  ...
  'settings.desktopHint': 'Configurer le comportement de l\'application de bureau.',
  'settings.autoLaunch': 'Lancer au démarrage',
  'settings.autoLaunchHint': 'Lancer automatiquement Open Design à la connexion.',
  'settings.network': 'Réseau',
  'settings.networkHint': 'Configurer la liaison du démon aux interfaces réseau.',
  'settings.networkRequiresDaemon': 'Connectez-vous à un démon en cours d\'exécution pour modifier les paramètres réseau.',
  'settings.networkWarning': 'Exposition réseau activée',
  'settings.networkWarningHint': 'Le démon est accessible depuis le réseau. Activez l\'authentification par clé API et définissez une liste d\'IP autorisées.',
  'settings.bindHost': 'Adresse de liaison',
  'settings.bindHostHint': '127.0.0.1 = localhost uniquement. 0.0.0.0 = toutes les interfaces réseau.',
  'settings.port': 'Port',
  'settings.portHint': 'Port TCP sur lequel le démon écoute. Par défaut : 7456.',
  'settings.allowedHosts': 'Hôtes autorisés',
  'settings.allowedHostsHint': 'IPs ou plages CIDR autorisées, séparées par des virgules. Vide = tout autoriser.',
  'settings.apiKeys': 'Clés API',
  'settings.apiKeysHint': 'Clés requises pour les connexions non locales lorsque l\'exposition réseau est activée.',
  'settings.revoke': 'Révoquer',
  'settings.newApiKey': 'Nouvelle clé API',
  'settings.newApiKeyHint': 'Copiez cette clé maintenant. Elle ne sera plus affichée.',
  'settings.keyLabel': 'Libellé (facultatif)',
  'settings.generateKey': 'Générer',
  'settings.networkKeyRequired': 'L\'accès réseau nécessite une clé API',
  'settings.networkKeyRequiredHint': 'La liaison à toutes les interfaces expose le daemon au réseau. Une clé API sera générée pour la sécurité.',
  'settings.generateAndSwitch': 'Générer une clé et basculer',
  'settings.networkNoKeysWarning': 'Impossible de redémarrer sans clé API',
  'settings.networkNoKeysWarningHint': 'Au moins une clé API est requise lorsque le daemon est exposé au réseau. Générez une clé ci-dessus avant de redémarrer.',
  'settings.networkRestartHint': 'Les modifications d\'adresse de liaison, de port ou d\'hôtes autorisés nécessitent un redémarrage du démon.',
  'settings.restartDaemon': 'Redémarrer le daemon',
  'settings.restartingDaemon': 'Redémarrage…',
  'settings.restartFailed': 'Le redémarrage a échoué. Veuillez redémarrer manuellement.',
  'settings.networkSaveError': 'Échec de l\'enregistrement. Vérifiez vos saisies et réessayez.',
  'settings.networkLoadError': 'Impossible de charger les paramètres réseau.',
  ...
  'settings.mcpTabRemote': 'Distant',
  'settings.mcpInstallTypeAria': 'MCP install type',
  'settings.mcpRemoteDisabled':
    'L\'accès distant nécessite que le démon soit lié à une adresse non-loopback. Démarrez avec --host 0.0.0.0 ou définissez OD_BIND_HOST pour exposer le démon sur le réseau.',
  'settings.mcpKeysTitle': 'Clés MCP',
  'settings.mcpKeysEmpty': 'Aucune clé MCP. Générez-en une pour l\'inclure automatiquement dans les extraits de configuration.',
  'settings.mcpKeysReveal': 'Afficher',
  'settings.mcpKeysRevoke': 'Révoquer',
  'settings.mcpKeysRevokeConfirm': 'Révoquer cette clé MCP ?',
  'settings.mcpKeysNetworkWarning': 'Le démon est exposé sur le réseau. Générez une clé MCP pour activer l\'authentification.',
  'settings.mcpKeysGenerate': 'Générer une clé MCP',
  'settings.mcpKeysRotate': 'Rotate token',
  'settings.mcpKeysShellEnv': '$OD_MCP_TOKEN saved to {file}',
  'settings.mcpInstructionGemini': 'Fusionnez ce JSON dans {path}.',
