...
export const ja: Dict = {
  ...
  'settings.desktopHint': 'デスクトップアプリの動作を設定します。',
  'settings.autoLaunch': 'ログイン時に起動',
  'settings.autoLaunchHint': 'ログイン時に Open Design を自動的に起動します。',
  'settings.network': 'ネットワーク',
  'settings.networkHint': 'デーモンのネットワークインターフェースバインディングを設定します。',
  'settings.networkRequiresDaemon': '実行中のデーモンに接続してネットワーク設定を変更できます。',
  'settings.networkWarning': 'ネットワーク公開が有効です',
  'settings.networkWarningHint': 'デーモンがネットワークからアクセス可能です。APIキー認証を有効にし、IP許可リストを設定してください。',
  'settings.bindHost': 'バインドアドレス',
  'settings.bindHostHint': '127.0.0.1 = ローカルホストのみ。0.0.0.0 = すべてのネットワークインターフェース。',
  'settings.port': 'ポート',
  'settings.portHint': 'デーモンがリッスンするTCPポート。デフォルト: 7456。',
  'settings.allowedHosts': '許可ホスト',
  'settings.allowedHostsHint': '接続を許可するカンマ区切りのIPまたはCIDR範囲。空 = すべて許可。',
  'settings.apiKeys': 'APIキー',
  'settings.apiKeysHint': 'ネットワーク公開時にローカル以外の接続に必要な認証キー。',
  'settings.revoke': '取り消し',
  'settings.newApiKey': '新しいAPIキー',
  'settings.newApiKeyHint': '今すぐこのキーをコピーしてください。再度表示されることはありません。',
  'settings.keyLabel': 'ラベル（任意）',
  'settings.generateKey': '生成',
  'settings.networkKeyRequired': 'ネットワークアクセスにはAPIキーが必要です',
  'settings.networkKeyRequiredHint': 'すべてのインターフェースにバインドすると、デーモンがネットワークに公開されます。セキュリティのためAPIキーが生成されます。',
  'settings.generateAndSwitch': 'キーを生成して切り替え',
  'settings.networkNoKeysWarning': 'APIキーなしで再起動できません',
  'settings.networkNoKeysWarningHint': 'デーモンがネットワークに公開されている場合、少なくとも1つのAPIキーが必要です。再起動前に上記でキーを生成してください。',
  'settings.networkRestartHint': 'バインドアドレス、ポート、または許可ホストの変更後はデーモンの再起動が必要です。',
  'settings.restartDaemon': 'デーモンを再起動',
  'settings.restartingDaemon': '再起動中…',
  'settings.restartFailed': '再起動に失敗しました。手動で再起動してください。',
  'settings.networkSaveError': '保存に失敗しました。入力内容を確認して再試行してください。',
  'settings.networkLoadError': 'ネットワーク設定の読み込みに失敗しました。',
