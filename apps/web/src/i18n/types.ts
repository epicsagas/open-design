...
export interface Dict {
  ...
  'settings.desktop': string;
  'settings.desktopHint': string;
  'settings.autoLaunch': string;
  'settings.autoLaunchHint': string;
  'settings.network': string;
  'settings.networkHint': string;
  'settings.networkRequiresDaemon': string;
  'settings.networkWarning': string;
  'settings.networkWarningHint': string;
  'settings.bindHost': string;
  'settings.bindHostHint': string;
  'settings.port': string;
  'settings.portHint': string;
  'settings.allowedHosts': string;
  'settings.allowedHostsHint': string;
  'settings.apiKeys': string;
  'settings.apiKeysHint': string;
  'settings.revoke': string;
  'settings.newApiKey': string;
